...
<html lang="en">
  <head>
    ...
    <title>Student Login Users</title>
    <link rel="icon" href="icon.jpg" type="image/icon type">
  </head>
  <body>
    <div class="container-fluid bg-dark">
      <div class="row">
        <div class="col-12 text-center" style="color: #fff;"><b><h2>Student Login Users</h2></b></div>
      </div>
    </div>
    <div class="container">
      <div class="row">
    ...
    <div class="container-fluid bg-dark">
      <div class="row">
        <div class="col-12 text-center">Generate Student Login</div>
      </div>
    </div>
...
$query = "INSERT INTO STUDENT_LOGIN VALUES ('$a','$b')";
