...
<html lang="en">
  ...
  <body>
    <div class="container-fluid bg-dark">
      <div class="row">
        <div class="col-12 text-center" style="color: #fff;"><b><h2>Library Book Registration</h2></b></div>
      </div>
    </div>
    <div class="container">
      <div class="row">
    ...
    <div class="form-group" style="">
      <label>Book No</label>
      <input type="text" name="book" value="" class="form-control"style="background-color: transparent;outline: none;border:none;border-bottom: 2px solid black;color: #fff;font-weight: bold;">
    </div>
      <div class="form-group" style="">
      <label>Book Name</label>
      <input type="text" name="bookname" value="" class="form-control"style="background-color: transparent;outline: none;border:none;border-bottom: 2px solid black;color: #fff;font-weight: bold;">
    </div>
     <div class="form-group" style="">
      <label>Return Date</label>
      <input type="text" name="returndate" value="" class="form-control"style="background-color: transparent;outline: none;border:none;border-bottom: 2px solid black;color: #fff;font-weight: bold;">
    </div>
    ...
    <div class="container-fluid bg-dark">
      <div class="row">
        <div class="col-12 text-center">Book Issue</div>
      </div>
    </div>
...
$query = "INSERT INTO LIBRARY VALUES ('$a','$b','$c','$d','$e','$f','$g','$h','$i')";
