...
<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet">
    ...
    <title>Semester3 Updation Form</title>
  </head>
  <body class="bg-light">
...
<div class="card-body" style="background-color: #fff;">
  <form action="" method="GET" >
    ...
    <div class="form-group">
      <label>Networking Security</label>
...
if($_GET['submit'])
{
	...
	$query = "UPDATE SEMESTER3 SET NAME='$nb' , FATHER='$nc' , COURSE='$nd' , YEAR='$ne' , PYTHON='$nf' , PHYSICS='$ng' ,LINUX='$nh' , DBMS='$ni' , NETWORKING='$nj' , TOTAL='$nk' , CGPA='$nl' WHERE ROLL='$na' ";
...
<div class="card-footer text-center bg-dark"><p style="color: #fff;letter-spacing: 1px;">Semester3 Update info Form</p></div>
</div>
