...
<html lang="en">
  ...
  <div class="btn-group" role="group">
    ...
    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      <li><a class="dropdown-item" href="libraryinsert.php">Issue Book</a></li>
       <li><a class="dropdown-item" href="displaylibrary.php">Book Record</a></li>
  ...
  <div class="btn-group" role="group">
    ...
    <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      <li><a class="dropdown-item" href="displayattendence.php">Attendence</a></li>
       <li><a class="dropdown-item" href="displaycalender.php">Accademic Calender</a></li>
  ...
  <div class="container-fluid"style="box-shadow: 2px 2px 5px #d9d9d9, -2px -2px 5px #fff;">
    <a class="navbar-brand" href="eye.html">Library</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="displaylibrary.php">Display Book Report</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" action="" method="GET">
        <input class="form-control me-2" type="search" placeholder="Enter Roll No" aria-label="Search" name="name">
