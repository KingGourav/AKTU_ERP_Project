...
<html lang="en">
  <head>
    ...
    <title> Hostel Staff Registration</title>
  </head>
  <body>
    <section>
    ...
    <div class="form-group" style="">
      ...
      <input type="text" name="experince" value="" class="form-control"style="background-color: transparent;outline: none;border:none;border-bottom: 2px solid black;color: #fff;font-weight: bold;">
    </div>
    ...
    <div class="container-fluid bg-dark">
      <div class="row">
        <div class="col-12 text-center">HostelStaff Registration Form</div>
      </div>
    </div>
</div>
</section>
...
$query = "INSERT INTO HOSTELSTAFF VALUES ('$a','$b','$c','$d','$e','$f','$g','$h','$i','$j','$k','$l','$m','$n','$folder')";
