...
<link href="https://fonts.googleapis.com/css2?family=Roboto&display=swap" rel="stylesheet">
    ...
    <title>Facuilty Notification</title>
  </head>
  <body class="bg-light">
   
<div class="container">
<div class="card-header text-center" style="background-color: orange;color: #fff;box-shadow: 0px 0px 4px 2px rgba(0,0,0,.5);"><h1>Facuilty Notification</h1></div>
...
$nz = $_GET['id'];
	...
	$query = "UPDATE NOTIFICATION_FACUILTY SET NEWS1='$na' , NEWS2='$nb' , NEWS3='$nc'  WHERE ID='$nz' ";
...
<div class="card-footer text-center bg-dark"><p style="color: #fff;letter-spacing: 1px;">Facuilty Notification</p></div>
</div>
