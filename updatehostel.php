...
<div class="card-body" style="background-color: #fff;">
  <form action="" method="GET" >
    ...
    <div class="form-group">
      ...
      <input type="text" name="experince" value="<?php  echo $_GET['n']; ?>" class="form-control">
    </div>
...
if($_GET['submit'])
{
	...
	$query = "UPDATE HOSTELSTAFF SET NAME='$nb' , AGE='$nc' , GENDER='$nd' , PROFFESION='$ne' , DAT='$nf' , CONTACT='$ng' ,WHATSUP='$nh' , SALARY='$ni' , FATHER='$nj' , MOTHER='$nk' , ADDRESS='$nl' , PROOF='$nm' ,EXPERINCE='$nn' WHERE ID='$na' ";
