...
error_reporting(0);
 ...
 $query = "SELECT `news1`, `news2`, `news3` FROM `notification_student`";
 ...
 <div class="container"style="margin-top: 50px; ">
          <div class="row">
                  ...
                  <div class="col-4 a" style="box-shadow: 2px 2px 5px #d9d9d9, -2px -2px 5px #fff;background-color: #fff;"><i class="fas fa-user fa-4x fa-align-center a"></i>
                   ...
                   <div class="col-4 a" style="box-shadow: 2px 2px 5px #d9d9d9, -2px -2px 5px #fff;background-color: #fff;">
                    <i class="fas fa-book-open fa-4x fa-align-center a"></i>
                    <br><a href="examform.php"><p class="text-center">Exam Form</p></a></div>
...
<a href="library1.php">
  ...
  <div class="col-4 a" style="box-shadow: 2px 2px 5px #d9d9d9, -2px -2px 5px #fff;background-color: #fff;"><i class="fas fa-poll fa-5x fa-align-center a"></i><br>
<a href="quize/login.html">
  <p class="text-center">Quize</p></a></div>
     <div class="col-4 a" style="box-shadow: 2px 2px 5px #d9d9d9, -2px -2px 5px #fff;background-color: #fff;"><i class="fas fa-certificate  fa-4x fa-align-center a"></i>
                   ...
                   <div class="col-4 a" style="box-shadow: 2px 2px 5px #d9d9d9, -2px -2px 5px #fff;background-color: #fff;"><i class="fas fa-award fa-5x fa-align-center a"></i><br><a href="e.php"><p class="text-center">Events</p></a></div>
