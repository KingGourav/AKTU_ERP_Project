...
if($_GET['submit'])
{
	...
	$query = "UPDATE SEMESTER2 SET NAME='$nb' , FATHER='$nc' , COURSE='$nd' , YEAR='$ne' , OS='$nf' , JAVA='$ng' ,PHP='$nh' , MATHS='$ni' , DS='$nj' , TOTAL='$nk' , CGPA='$nl' WHERE ROLL='$na' ";
...
<div class="card-footer text-center bg-dark"><p style="color: #fff;letter-spacing: 1px;">Semester2 Update info Form</p></div>
</div>
