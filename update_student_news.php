...
<div class="container">
<div class="card-header text-center" style="background-color: orange;color: #fff;box-shadow: 0px 0px 4px 2px rgba(0,0,0,.5);"><h1>Student Notification</h1></div>
...
$nz = $_GET['id'];
	...
	$query = "UPDATE NOTIFICATION_STUDENT SET NEWS1='$na' , NEWS2='$nb' , NEWS3='$nc'  WHERE ID='$nz' ";
