<?php
include ("connection.php"); error_reporting(0); $query1 = "SELECT `news1`, `news2`, `news3` FROM `notification_website`"; $data1 = mysqli_query($conn, $query1); $total1 = mysqli_num_rows($data1); while ($result1 = mysqli_fetch_assoc($data1)) { $ne1=$result1['news1']; $ne2=$result1['news2']; $ne3=$result1['news3']; }
...
<section class="main_heading my-5">
  <div class=" text-center">
<h1 class="display-4 wow zoomIn" style="font-family: sans-serif; ">Hackaton AT Campus</h1>
<hr class="w-25 mx-auto"/>
</div>
...
<div class="container" style="margin-top: 20px;">
  <div class="row">
    <div class="col-4">
     <div class="card" style="width: 20rem;box-shadow: 0 5px 35px rgba(0,0,0,0.2); ">
  <img src="h1.gif" class="card-img-top" alt="..."style="height: 260px;">
  <div class="card-body">
    <h5 class="card-title"style="color: #000;">Campus Hackaton</h5>
    <p class="card-text"style="text-align: center;justify-content: center;">A hackathon is an event, usually hosted by a tech company or organization</p>
    <a href="https://www.youtube.com/watch?v=9fbfz7zJMwQ&t=4s" class="btn btn-primary  wow bounceIn"style="background-color: orange;border:none; font-weight: bold;">See project</a>
  </div>
</div>
    </div>
    <div class="col-4"> <div class="card" style="width: 20rem;box-shadow: 0 5px 35px rgba(0,0,0,0.2); ">
  <img src="h2.gif" class="card-img-top" alt="..."style="height: 260px;">
  <div class="card-body">
    <h5 class="card-title"style="color: #000;">Online Hackaton</h5>
    <p class="card-text">A hackathon is an event, hosted by a Google company or organization</p>
    <a href="#" class="btn btn-primary  wow bounceIn"style="background-color: orange;border:none; font-weight: bold;">See project</a>
  </div>
</div></div>
    <div class="col-4"> <div class="card" style="width: 20rem;box-shadow: 0 5px 35px rgba(0,0,0,0.2); ">
  <img src="h3.gif" class="card-img-top" alt="..."style="height: 260px;">
  <div class="card-body">
    <h5 class="card-title"style="color: #000;">Other Campus</h5>
    <p class="card-text">A hackathon is an event,  hosted by a Ambalika institutions</p>
    <a href="#" class="btn btn-primary wow bounceIn"style="background-color: orange;border:none; font-weight: bold;">See project</a>
  </div>
