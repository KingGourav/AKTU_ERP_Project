  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group" style="">
      ...
      <input type="text" name="name" value="" class="form-control">
         ...
         <div class="form-group" style="">
      <label>Roll</label>
      <input type="text" name="roll" value="" class="form-control">
    </div>
    <div class="form-group" style="">
      <label>Course</label>
    ...
    <div class="form-group">
      <label>Whatsup</label>
      <input type="text" name="whatsup1" value="" class="form-control">
    </div>
    <div class="form-group">
      <label>mail</label>
...
if ($a1!="" && $a!="" && $b!=""&&$c!="" && $d!="" && $e!="" && $f!="" && $g!="" && $h!="" && $i!="" && $j!="" && $k!="" && $l!="" && $m!="" && $n!="" && $o!="" && $p!="" && $folder!="") {


$query = "INSERT INTO STUDENT1 VALUES ('$a1','$a','$b','$c','$d','$e','$f','$g','$h','$i','$j','$k','$l','$m','$n','$o','$p','$folder')";
