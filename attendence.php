...
<html lang="en">
  <head>
    ...
    <title>Upload Attendence</title>
  </head>
  <body>
    <div class="container-fluid bg-dark">
      <div class="row">
        <div class="col-12 text-center" style="color: #fff;"><b><h2>Upload Attendence</h2></b></div>
      </div>
    </div>
    <div class="container">
      <div class="row">
    ...
    <div class="form-group" style="">
     ...
     <div class="form-group" style="">
      <label>Month</label>
      <input type="text" name="month" value="" class="form-control"style="background-color: transparent;outline: none;border:none;border-bottom: 2px solid black;color: #fff;font-weight: bold;">
    </div>
    <div class="form-group" style="">
      <label>Year</label>
    ...
    <div class="form-group" style="">
      ...
      <input type="text" name="attendence" value="" class="form-control"style="background-color: transparent;outline: none;border:none;border-bottom: 2px solid black;color: #fff;font-weight: bold;">
    </div>
...
$query = "INSERT INTO ATTENDENCE VALUES ('$a','$b','$c','$d','$e','$f','$g')";
