...
<td><a href='updatefee.php?a=$result[roll]&b=$result[name]&c=$result[father]&d=$result[course]&e=$result[branch]&f=$result[dat]&g=$result[semester1]&h=$result[semester2]&i=$result[semester3]&j=$result[semester4]&k=$result[semester5]&l=$result[semester6]&m=$result[semester7]&n=$result[semester8]&o=$result[total]&p=$result[leftamount]'>Edit</a></td>

     <td><a href='feedelete.php?a=$result[roll]'onclick='return checkdelete()'>Delete</a></td>
