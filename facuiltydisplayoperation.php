...
<td>".$result['floor']."</td>
<td>".$result['cabin']."</td>
<td><a href='updatefacuiltyinfo.php?z=$result[id]&a=$result[name]&b=$result[gender]&c=$result[dob]&d=$result[proffesion]&e=$result[contact]&f=$result[whatsup]&g=$result[mail]&h=$result[address]&i=$result[qulification]&j=$result[experince]&k=$result[experincetime]&l=$result[post]&m=$result[building]&n=$result[floor]&o=$result[cabin]'>Edit</a></td>

     <td><a href='facuiltydelete.php?z=$result[id]'onclick='return checkdelete()'>Delete</a></td>
